    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      />
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            ...
            <strong>a hybrid technology approach,</strong>. <br />
             combining Face-API.js machine learning with computer vision geometric analysis.
          </p>
        </div>
            ...
            <div className={`text-sm ${isRealDetection ? 'text-green-800' : 'text-red-800'}`}>
              ...
              {isRealDetection && (
                <p className="mt-1 text-xs text-green-700">
                  Detection is running in advanced hybrid mode.
                </p>
              )}
            </div>
          </div>
        ...
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-start">
          ...
          <div className="text-sm text-blue-800">
            <strong>Open source technology:</strong> you can contribute and make this code grow stronger and more precise. All files are on on  <a href="https://github.com/rubengte/SmileRise" target="_blank" rel="noopener noreferrer">
          GitHub.
        </a>
          </div>
        </div>
